...
ninja.data = [{
    ...
    handler: () => {
      ...
      handler: () => {
    ...
    },{id: "news-i-stepted-into-career-life-in-middaydreams-chattogram-bangladesh-as-a-python-developer",
          title: 'I stepted into career life in Middaydreams, Chattogram, Bangladesh as a Python Developer....',
          description: "",
          ...
          section: "Projects",handler: () => {
            ...
            },},{id: "projects-explaining-machine-learning-models-for-sentiment-analysis-using-lime",
          title: 'Explaining Machine Learning Models for Sentiment Analysis Using LIME',
          description: "",
          section: "Projects",handler: () => {
              window.location.href = "/projects/2_project/";
            },},{id: "projects-a-comparison-study-of-pre-trained-and-randomly-initialized-models-on-image-and-sequence-data",
          title: 'A comparison study of pre-trained and randomly initialized models on image and sequence...',
          description: "",
          section: "Projects",handler: () => {
        ...
        section: 'Socials',
        handler: () => {
          window.open("mailto:%73%68%61%6E%74%61%6E%75.%63%73%65@%73%74%64.%63%75.%61%63.%62%64", "_blank");
        },
      },{
        id: 'social-github',
        title: 'GitHub',
        section: 'Socials',
        handler: () => {
          window.open("https://github.com/shantanu778", "_blank");
        },
      },{
        id: 'social-linkedin',
        title: 'LinkedIn',
        section: 'Socials',
        handler: () => {
          window.open("https://www.linkedin.com/in/shantanu778", "_blank");
        },
      },{
        id: 'social-rss',
        title: 'RSS Feed',
        ...
        section: 'Socials',
        handler: () => {
          window.open("https://scholar.google.com/citations?user=XDVd-tQAAAAJ", "_blank");
        },
      },{
      id: 'light-theme',
